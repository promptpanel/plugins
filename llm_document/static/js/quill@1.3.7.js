...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e) {
      ...
      t.exports = function t() {
        var e,
          ...
          p = arguments.length,
          d = !1;
        for ("boolean" == typeof f && ((d = f), (f = arguments[1] || {}), (h = 2)), (null == f || ("object" != typeof f && "function" != typeof f)) && (f = {}); h < p; ++h) if (null != (e = arguments[h])) for (n in e) (r = u(f, n)), (o = u(e, n)), f !== o && (d && o && (a(o) || (i = l(o))) ? (i ? ((i = !1), (c = r && l(r) ? r : [])) : (c = r && a(r) ? r : {}), s(f, { name: n, newValue: t(d, c, o) })) : void 0 !== o && s(f, { name: n, newValue: o }));
        return f;
      };
    },
    function (t, e, n) {
      ...
      (s.prototype.insert = function (t, e) {
        ...
        (s.prototype.compose = function (t) {
          ...
          if (null != i && "number" == typeof i.retain && null == i.attributes) {
            for (var a = i.retain; "insert" === e.peekType() && e.peekLength() <= a; ) (a -= e.peekLength()), r.push(e.next());
    ...
    function (t, e, n) {
      ...
      (S.DEFAULTS = { bounds: null, formats: null, modules: {}, placeholder: "", readOnly: !1, scrollingContainer: null, strict: !0, theme: "default" }), (S.events = g.default.events), (S.sources = g.default.sources), (S.version = "1.3.7"), (S.imports = { delta: d.default, parchment: w.default, "core/module": _.default, "core/theme": T.default }), (e.expandConfig = l), (e.overload = s), (e.default = S);
    },
    function (t, e, n) {
      "use strict";
      function r(t, e) {
        ...
        D = (function (t) {
          function e(t, n) {
            ...
            return (
              ...
              /Firefox/i.test(navigator.userAgent) ? (r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0 }, u), r.addBinding({ key: e.keys.DELETE }, { collapsed: !0 }, c)) : (r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0, prefix: /^.?$/ }, u), r.addBinding({ key: e.keys.DELETE }, { collapsed: !0, suffix: /^.?$/ }, c)),
              r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !1 }, f),
              r.addBinding({ key: e.keys.DELETE }, { collapsed: !1 }, f),
              r.addBinding({ key: e.keys.BACKSPACE, altKey: null, ctrlKey: null, metaKey: null, shiftKey: null }, { collapsed: !0, offset: 0 }, u),
              r.listen(),
              r
            );
          }
            ...
            l(e, [
              {
                key: "value",
                value: function (t) {
                  return a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "value", this)
                    .call(this, t)
                    .replace(/["']/g, "");
                },
              },
    ...
    function (t, e, n) {
      ...
      var o = n(46),
        ...
        et = n(108),
        nt = r(et);
      i.default.register({ "attributors/attribute/direction": a.DirectionAttribute, "attributors/class/align": l.AlignClass, "attributors/class/background": y.BackgroundClass, "attributors/class/color": v.ColorClass, "attributors/class/direction": a.DirectionClass, "attributors/class/font": b.FontClass, "attributors/class/size": g.SizeClass, "attributors/style/align": l.AlignStyle, "attributors/style/background": y.BackgroundStyle, "attributors/style/color": v.ColorStyle, "attributors/style/direction": a.DirectionStyle, "attributors/style/font": b.FontStyle, "attributors/style/size": g.SizeStyle }, !0), i.default.register({ "formats/align": l.AlignClass, "formats/direction": a.DirectionClass, "formats/indent": s.IndentClass, "formats/background": y.BackgroundStyle, "formats/color": v.ColorStyle, "formats/font": b.FontClass, "formats/size": g.SizeClass, "formats/blockquote": c.default, "formats/code-block": R.default, "formats/header": h.default, "formats/list": d.default, "formats/bold": _.default, "formats/code": M.Code, "formats/italic": w.default, "formats/link": k.default, "formats/script": N.default, "formats/strike": A.default, "formats/underline": T.default, "formats/image": S.default, "formats/video": L.default, "formats/list/item": p.ListItem, "modules/formula": B.default, "modules/syntax": U.default, "modules/toolbar": H.default, "themes/bubble": tt.default, "themes/snow": nt.default, "ui/icons": z.default, "ui/picker": Z.default, "ui/icon-picker": X.default, "ui/color-picker": G.default, "ui/tooltip": Q.default }, !0), (e.default = i.default);
    },
    function (t, e, n) {
      "use strict";
      function r(t) {
          ...
          return (
            ...
            (e.prototype.update = function (e, n) {
              ...
              void 0 === n && (n = {}),
                ...
                null != this.domNode[i.DATA_KEY].mutations && t.prototype.update.call(this, this.domNode[i.DATA_KEY].mutations, n),
                this.optimize(e, n);
            }),
            (e.blotName = "scroll"),
      ...
      function h(t) {
        for (
          ...
          t[r - 2][0] === v &&
            ...
            t[r][0] === y &&
            n(t[r][1]) &&
            ((e = !0), (t[r - 1][1] = t[r - 2][1].slice(-1) + t[r - 1][1]), (t[r][1] = t[r - 2][1].slice(-1) + t[r][1]), (t[r - 2][1] = t[r - 2][1].slice(0, -1)));
        if (!e) return t;
